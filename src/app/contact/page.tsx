    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          {/* Main Booking Form */}
          <div className="lg:col-span-7 p-8 rounded-3xl bg-white dark:bg-[#090e1b] border border-slate-200 dark:border-white/10 shadow-2xl space-y-6">
            ...
            {!submitted ? (
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-xs font-semibold text-slate-700 dark:text-slate-300 mb-1">Target Service Area *</label>
                    <select
                      value={formData.service}
                      onChange={(e) => setFormData({ ...formData, service: e.target.value })}
                      className="w-full px-4 py-2.5 rounded-xl bg-slate-50 dark:bg-[#090e1b] border border-slate-300 dark:border-white/10 text-slate-900 dark:text-white text-xs focus:outline-none focus:border-cyan-400"
                    >
                      {CATEGORIES.map((c) => (
                  ...
                  <div>
                    <label className="block text-xs font-semibold text-slate-700 dark:text-slate-300 mb-1">Target Audit Timeline *</label>
                    <select
                ...
                <div>
                  <label className="block text-xs font-semibold text-slate-700 dark:text-slate-300 mb-1">Assessment Scope & Requirements *</label>
                  <textarea
                    rows={4}
                    required
                    ...
                    className="w-full px-4 py-2.5 rounded-xl bg-slate-50 dark:bg-[#090e1b] border border-slate-300 dark:border-white/20 text-slate-900 dark:text-white placeholder-slate-500 text-xs focus:outline-none focus:border-cyan-400"
                  />
                </div>
                ...
                <div className="flex items-center gap-2 pt-1">
                  <input
                    ...
                    className="w-4 h-4 rounded text-cyan-600 dark:text-cyan-400 bg-slate-100 dark:bg-[#090e1b] border-slate-300 dark:border-white/20 focus:ring-0"
                  />
              ...
              <div className="p-8 text-center space-y-4 rounded-2xl bg-emerald-50 dark:bg-emerald-950/40 border border-emerald-200 dark:border-emerald-500/30">
                <CheckCircle2 className="w-12 h-12 text-emerald-600 dark:text-emerald-400 mx-auto" />
                <h3 className="text-xl font-bold text-emerald-700 dark:text-emerald-300">Scoping Inquiry Received</h3>
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="p-6 rounded-2xl bg-white dark:bg-[#090e1b] border border-slate-200 dark:border-white/10 space-y-4 text-xs">
              <h4 className="font-bold text-slate-900 dark:text-white font-mono uppercase tracking-wider text-cyan-400">
                Direct Channels
              </h4>
              <div className="space-y-2">
                <div className="flex items-center gap-2 text-slate-600 dark:text-slate-300">
                  <Mail className="w-4 h-4 text-cyan-600 dark:text-cyan-400 shrink-0" />
                  <span>General Scoping: <strong className="text-slate-900 dark:text-white">contact@rawseclabs.com</strong></span>
                </div>
                <div className="flex items-center gap-2 text-slate-600 dark:text-slate-300">
            ...
            {/* PGP Block */}
            <div className="p-6 rounded-2xl bg-white dark:bg-[#090e1b] border border-slate-200 dark:border-white/10 space-y-3 font-mono text-xs">
              <div className="flex items-center gap-2 text-slate-700 dark:text-slate-300 font-bold">
                <Key className="w-4 h-4 text-cyan-400" />
                <span>Secure PGP Public Key</span>
              </div>
              <div className="p-3 rounded-lg bg-slate-100 dark:bg-black/50 border border-slate-300 dark:border-white/5 text-[10px] text-slate-600 dark:text-slate-400 break-all">
