...
export const metadata: Metadata = {
  title: 'Security Products | RawSecLabs',
  description: 'Comprehensive security tools and platforms designed to protect your organisation.',
};
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-cyan-500/10 border border-cyan-500/30 mb-6">
              ...
              <span className="text-sm font-semibold text-cyan-700 dark:text-cyan-300">Security Products</span>
            </div>
            ...
            <p className="text-lg md:text-xl text-slate-600 dark:text-slate-300 mb-8 max-w-3xl mx-auto">
              Comprehensive security tools and platforms designed to protect your organisation.
            </p>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-white dark:bg-[#0b101d] border border-slate-200 dark:border-white/10 rounded-2xl p-12">
            ...
            <p className="text-slate-600 dark:text-slate-400 mb-6">
              We&apos;re developing cutting-edge security products to enhance your cybersecurity posture. Stay tuned for upcoming releases.
            </p>
            <Link
              href="/contact"
