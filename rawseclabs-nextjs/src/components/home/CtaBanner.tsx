  ...
  return (
    <section className="py-20 bg-[#060911] relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="relative rounded-3xl p-8 sm:p-14 bg-gradient-to-r from-cyan-950/40 via-slate-900 to-emerald-950/40 border border-cyan-500/30 overflow-hidden shadow-2xl shadow-cyan-950/50">
          ...
          <div className="relative z-10 max-w-3xl space-y-6">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-cyan-500/20 text-cyan-300 border border-cyan-500/30 text-xs font-mono font-bold">
            ...
            <div className="pt-4 flex flex-col sm:flex-row items-center gap-4">
              ...
              <Link
                href="/assessment"
                className="w-full sm:w-auto px-6 py-4 rounded-xl bg-white/[0.05] hover:bg-white/[0.1] text-white border border-white/10 text-sm font-semibold transition-colors flex items-center justify-center gap-2"
              >
            ...
            <div className="pt-4 flex items-center gap-4 text-xs text-slate-400">
              <span className="flex items-center gap-1.5">
                <Lock className="w-3.5 h-3.5 text-cyan-400" /> Mutual NDA Covered
              </span>
              <span>&bull;</span>
              <span>CREST-Accredited Senior Consultants</span>
              <span>&bull;</span>
